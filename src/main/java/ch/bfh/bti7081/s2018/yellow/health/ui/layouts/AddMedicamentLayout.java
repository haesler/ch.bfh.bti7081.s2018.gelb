...
public class AddMedicamentLayout extends AbsoluteLayout {
	...
	private Button bu_new;
	private Button bu_delete;
	private Grid<ch.bfh.bti7081.s2018.yellow.health.models.Medicament> gr_Medicaments;
	private Button bu_save;
	private Button bu_cancel;
	private FormLayout fl_edit;
	...
	public Button getBu_new() {
		return bu_new;
	}

	public Button getBu_delete() {
		return bu_delete;
	}

	public Grid<ch.bfh.bti7081.s2018.yellow.health.models.Medicament> getGr_Medicaments() {
	...
	public Button getBu_cancel() {
		return bu_cancel;
	}

	public FormLayout getFl_edit() {
		return fl_edit;
	}
